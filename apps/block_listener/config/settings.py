...
from ethereum_service.config.infra.base_settings import (
    BaseInfraSettings,
    InfraSettings,
    get_infra_settings,
)
...
class RestAPIServiceSettings(BaseInfraSettings):
    ...
    model_config = SettingsConfigDict(
        ...
        env_prefix="ETHEREUM_",
        env_file_encoding="utf-8",
        extra="ignore",
    )

    # Service metadata
    TITLE: str = "CryptoWallet — ethereum service"
    DESCRIPTION: str = "service for interacting with Ethereum blockchain"
    DEBUG: bool = False
